...
- 推論 UI は backend を `TensorRT FP16`, `PyTorch FP16`, `PyTorch FP32` から選べます。`samurai-ulr` の既定値は互換性のため `TensorRT FP16`、`t260-ulr` の既定値は RF-DETR TensorRT 検証前のため `PyTorch FP16` です。
...
- 2026-04-29 時点の Phase 1 E2E 期待値は `8 passed, 3 skipped` です。
